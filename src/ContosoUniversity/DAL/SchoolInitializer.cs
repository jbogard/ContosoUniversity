    ...
    public class SchoolInitializer : System.Data.Entity.DropCreateDatabaseIfModelChanges<SchoolContext>
    {
        protected override void Seed(SchoolContext context)
        {
            ...
            var instructors = new List<Instructor>
            {
                ...
                new Instructor
                    { FirstMidName = "Mark", LastName = "Scottman", HireDate = DateTime.Parse("2003-04-11") },
            ...
            var departments = new List<Department>
            {
                new Department
                {
                    Administrator = instructors[0], Budget = 1200, Name = "Science",
                    StartDate = DateTime.Parse("1990-04-01")
                },
                new Department
                {
                    Administrator = instructors[1], Budget = 1200, Name = "Business",
                    StartDate = DateTime.Parse("1990-04-01")
                },
                new Department
                {
                    Administrator = instructors[2], Budget = 1200, Name = "Math",
                    StartDate = DateTime.Parse("1990-04-01")
                },
                new Department
                {
                    Administrator = instructors[3], Budget = 1200, Name = "English",
                    StartDate = DateTime.Parse("1990-04-01")
                }
            };
